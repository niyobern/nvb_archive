        ...
        <div className="py-2 md:py-8 flex flex-col justify-center content-center">
            <div className="rounded bg-white shadow-lg shadow-gray-400 p-4 mx-auto flex flex-col">
                ...
                <div className="flex flex-col gap-2 mt-2">
                    {question.options && question.options.map((item: any) => <div className="rounded bg-gray-200 p-2 hover:bg-gray-300 hover:shadow-lg active:text-white cursor-pointer">Option 1 Lorem ipsum dolor</div>)}
                </div>
            </div>
        </div>
    )
