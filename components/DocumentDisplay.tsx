...
export default function DocumentDisplay({ items, fields, fieldnames, showPop, close, formResponse, token, leader }: any){
  ...
  <button onClick={handleHidden} className={`${hidden && !leader ? "flex": "hidden"} fixed z-90 bottom-6 right-6 bg-green-600 w-14 h-14 rounded-full drop-shadow-lg justify-center items-center text-white text-4xl hover:bg-blue-700 hover:drop-shadow-2xl`}>
