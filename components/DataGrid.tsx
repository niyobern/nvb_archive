...
export default function DataGrid({ items, fields, fieldnames, showPop, close, formResponse, token }: any){
  ...
  <div className={`${hidden ? "flex" : "flex" } bg-sky-400 items-center`}><FormApply fields={fields} fieldnames={fieldnames} clicked={handleHidden} initial={initial} token={token}/></div>
