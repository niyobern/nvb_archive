...
export default function TableR({ items, titles, fields, fieldnames, showPop, close, formResponse, bonus }: any){
 ...
 <div className="h-screen py-5">
    <div className={`${hidden ? "hidden" : "flex" } fixed bg-sky-400 flex-col items-center w-screen md:mx-36 lg:mx-48 xl:mx-64 md:mt-24 md:w-1/2`}><AddSingle fields={fields} fieldnames={fieldnames} clicked={handleHidden} bonus={bonus}/></div>
