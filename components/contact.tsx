            ...
            <div className="flex flex-col h-fit md:grid grid-rows-6 grid-cols-2">
                ...
                <div className="row-start-3 col-span-full row-span-4 md:p-2 bg-gray-100 md:mx-24 z-20 flex flex-col md:grid grid-cols-5 grid-rows-2 gap-y-4 gap-x-8">
                    <div className="grid grid-cols-5 grid-rows-3 bg-white shadow col-start-1 col-span-2 row-start-1 py-10 gap-x-4 md:pl-12">
                        ...
                        <div className="col-start-2 col-span-4 row-span-1 self-center text-sky-600 text-sm hover:bg-sky-600 hover:text-white active:bg-red-500 active:text-white w-fit py-2 hover:px-2 cursor-pointer rounded" id="contact5">text 29865</div>
                    </div>
                    <div className="grid grid-cols-5 grid-rows-3 bg-white shadow col-start-1 col-span-2 row-start-2 py-10 md:pl-8">
                        ...
                        <span className="col-start-2 col-span-4 row-span-1 self-center text-gray-600 pl-2" id="contact7">text 5</span>
                        <div className="col-start-2 col-span-4 row-span-2 self-center text-white bg-sky-600 cursor-pointer hover:bg-green-600 active:bg-red-500 py-2 px-6 justify-self-start" id="contact6">text 100</div>
                    </div>
                    <div className="flex flex-col col-start-3 col-span-3 row-span-2 bg-white shadow-xl pt-8">
                        <h1 className="text-xl font-bold self-center text-gray-800" id="contact8">text 6</h1>
                        <div className="text-sm sefl center text-center py-2" id="contact9">text 7</div>
                        <div className="flex flex-col md:grid grid-cols-2 p-2 md:px-10 gap-2">
                            <div className="flex flex-col py-2">
                                <label htmlFor="firstName" className="pb-1 text-sm uppercase text-gray-700" id="contact13">hhdfkuds </label>
                            ...
                            <div className="flex flex-col py-2">
                                <label htmlFor="lastName" className="pb-1 text-sm uppercase text-gray-700" id="contact10">textv 4</label>
                            ...
                            <div className="flex flex-col py-2">
                                <label htmlFor="email" className="pb-1 text-sm uppercase text-gray-700" id="contact11">text 908</label>
                            ...
                            <div className="flex flex-col py-2">
                                <label htmlFor="phone" className="pb-1 text-sm uppercase text-gray-700" id="contact12">text 344</label>
                            ...
                            <div className="flex flex-col py-2">
                                <label htmlFor="message" className="pb-1 text-sm uppercase text-gray-700" id="contact14">txt 10</label>
                            ...
                            <div className="flex flex-col py-2">
                                ...
                                <div className="bg-sky-600 rounded hover:bg-green-600  active:bg-red-500 h-20 cursor-pointer w-full text-xl font-bold uppercase text-white text-center flex items-center justify-center" id="contact15">text 67</div>
                            </div>
                        </div>
                    </div>
                </div>
