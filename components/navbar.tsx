...
export default function NavBar(){
    ...
    return (
        <div className="border-b border-gray-200 py-4 flex flex-row justify-between px-12">
            <span className="text-4xl font-bold text-green-800">NVB</span>
            <div></div>
            <div className="gap-4 justify-between flex flex-row text-xl">
                <div className="border text-green-700 rounded flex flex-row gap-1 py-1 px-3 hover:bg-green-600 hover:text-white hover:shadow-green-600 cursor-pointer active:text-red-500">
                ...
                <div onPointerEnter={handleShow} onPointerLeave={handleShow} className="border flex gap-2 flex-row rounded bg-green-600 text-white py-1 px-3 hover:shadow cursor-pointer active:text-red-500">
                    <span>Kwinjira</span>
