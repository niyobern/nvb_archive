...
export default function SideBar( { data, title }: any){
    return (
        <div className="w-full bg-teal-700 py-4  max-h-screen">
            <ul className="pl-4 pr-2 flex flex-col gap-2 text-white font-normal overflow-y-scroll scrollbar-thin pb-24">
